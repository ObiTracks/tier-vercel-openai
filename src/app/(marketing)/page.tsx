...
import { EmailNotify, UseCaseChip } from "./components"; // import the client component
  ...
  return (
    <>
      ...
      <div className="mt-32 flex flex-col items-center gap-6">
        ...
        <p className=" w-full mt-6 text-sm sm:text-base md:text-lg lg:text-xl xl:text-lg font-light text-center text-slate-11 md:w-[572px] md:px-0 leading-snug">
          <span className="text-white opacity-100 font-semibold">Fully automated,</span> procedural, and <span className="text-white font-bold">rapid software development,</span> powered by collaborative AI agents. All <span className="text-white font-bold">with you in the loop.</span>
        </p>
      ...
      <section className="mt-8">
        <h3 className="text-center">How do you see yourself using agents to build?</h3>
      ...
      <div className="mb-40 mt-20 flex flex-col items-center gap-4">
        ...
        <div className="flex flex-col items-center gap-2 md:flex-row md:gap-4">
          <button className="block bg-green-500 text-white px-4 py-2 rounded-md">Sign Up</button>
        </div>
